...
describe('ItemList component', () => {
  ...
  it('should render a list of Items with the received data', () => {
    render(
      <MemoryRouter>
        <ItemList articles={articlesMockData} />
      </MemoryRouter>
    );
    ...
    expect(screen.getByTestId('item-list-container')).toMatchInlineSnapshot(`
      ...
      >
        <a
          href="/products/Capital Cities/In a Tidal Wave of Mistery"
        ...
        <a
          href="/products/Rejjie Snow/Dear Annie"
          style="text-decoration: none; color: black; display: flex;"
        >
          <div
            class="item-container"
        ...
        <a
          href="/products/Kota the Friend/FOTO"
          style="text-decoration: none; color: black; display: flex;"
        >
          <div
            class="item-container"
        ...
        <a
          href="/products/Playboi Carti/Die Lit"
          style="text-decoration: none; color: black; display: flex;"
        >
          <div
            class="item-container"
        ...
        <a
          href="/products/Post Malone/Hollywood's Bleeding"
          style="text-decoration: none; color: black; display: flex;"
        >
          <div
            class="item-container"
        ...
        <a
          href="/products/Coral Casino/Lejos"
          style="text-decoration: none; color: black; display: flex;"
        >
          <div
            class="item-container"
        ...
        <a
          href="/products/6lack/FREE 6LACK"
          style="text-decoration: none; color: black; display: flex;"
        >
          <div
            class="item-container"
